...
const SingleCard = ({ card, handleClick, selectedCard, loggedUsername, playerOnTheMoveUsername, turnsPassedWithSpecialCard }) => {
    ...
    function handleClickOnCard() {
        if (card.value === 2) {
            if (turnsPassedWithSpecialCard !== undefined) {
                if (loggedUsername === playerOnTheMoveUsername) {
    ...
    return (
        ...
        <div className={`CardViewDiv ${selectedCardDiv} p-3 m-2`} onClick={handleClickOnCard}>
